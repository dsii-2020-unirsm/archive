Immaterials: Light painting WiFi, 2012, Timo Arnall, Jorn Knutsen, Einar Sneve.
...
La riflessione che nasce dal progetto non è solo un’indagine alla ricerca dei luoghi con il segnale migliore, ma anche la differenza stessa che si evidenzia tra le diverse zone osservate: “Piccole reti domestiche in vecchi condomini scorrono nelle strade in modi diversi rispetto alle reti di grandi istituzioni. Le fitte aree residenziali hanno reti più ampie ma più brevi rispetto a parchi e campus” (http://yourban.no/2011/02/22/immaterials-light-painting-wifi/).Inoltre il progetto prende in esame anche la spazialità del WiFi, rendendo evidente come la città stessa vada a modellare il modo in cui le reti si diffondono attraverso essa, con le sue forme architettoniche, i materiali di costruzione, il paesaggio urbano.
