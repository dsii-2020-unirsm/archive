// -
// Sound Classification 0.4 by Angelica Gasperoni [sound, draw]
...
function preload() {
  ...
  model = ml5.sketchRNN('cat'); //questo non va qui, ma in carica modello
}
...
function caricaModello(cosae) {   // If something new to draw
  if (strokePath) { //questo va nel draw, va in "se questa cosa è vero allora.."
